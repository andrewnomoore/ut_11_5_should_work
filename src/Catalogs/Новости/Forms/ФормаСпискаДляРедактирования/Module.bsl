...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = ОбработкаНовостейКлиент.ВсеОповещения().СкопированыВсеКатегории Тогда
		Если ТипЗнч(Параметр) = ТипСтруктура Тогда
			ЗаполнитьБуферОбменаКатегорийСервер(Параметр);
		КонецЕсли;
	ИначеЕсли ИмяСобытия = ОбработкаНовостейКлиент.ВсеОповещения().ПослеЗаписиНовости Тогда
